...
.equ DDRL = 0x10A
		...
		sts DDRB, r17   ; PORT B as output
		sts DDRL, r17   ; PORT L as output

lp:
		ldi r19, 0b00000010 ; turn on LED on pin 52
		sts PORTB, r19
		ldi r19, 0x80       ; turn on LED on pin 42
		sts PORTL, r19
; delay loop for LED on duration
		ldi r20, 0x40
...
del3:	nop
		...
		ldi r19, 0x00          ; turn off the LEDs
		sts PORTB, r19
		sts PORTL, r19
		; do you need to reset the value for r20 here?
		; call the function here
		;ldi r20, 0x40
; delay loop for LED off duration
del1_2:	nop
		ldi r21,0xFF
del2_2:	nop
		ldi r22, 0xFF
